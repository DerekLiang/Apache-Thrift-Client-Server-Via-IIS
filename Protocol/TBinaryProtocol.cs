...
namespace Thrift.Protocol
{
	public class TBinaryProtocol : TProtocol
	{
		...
		{
			ReadAll(i64in, 0, 8);
			return (long)(((ulong)(i64in[0] & 0xff) << 56) | ((ulong)(i64in[1] & 0xff) << 48) | ((ulong)(i64in[2] & 0xff) << 40) | ((ulong)(i64in[3] & 0xff) << 32) |
				((ulong)(i64in[4] & 0xff) << 24) | ((ulong)(i64in[5] & 0xff) << 16) | ((ulong)(i64in[6] & 0xff) << 8) | ((ulong)(i64in[7] & 0xff) << 0));
		}
